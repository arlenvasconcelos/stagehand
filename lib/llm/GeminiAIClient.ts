...
export class GeminiAIClient extends LLMClient {
  public type = "geminiai" as const;
  ...
  async createChatCompletion<T = LLMResponse>({
    ...
    // Hardcoded for now, need to find a better way to do this
    // Delete to keep compatible with GeminiAI
